...
export const addSmurf = (name, position, nickname, description) => dispatch => {
    if (!name || !nickname || !position) {
        dispatch({type:FORM_ERROR, payload:"Name, nickname, and position are required."})
    } else {
...
export const setErrorText = (errorText) => {
    ...
    return {type:FORM_ERROR, payload:errorText};
}
